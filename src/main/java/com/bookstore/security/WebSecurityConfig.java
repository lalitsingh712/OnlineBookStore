        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> 
                    auth.requestMatchers("/api/auth/**").permitAll()
                        ...
                        .requestMatchers("/api/chat/**").permitAll() // Public chatbot
                        .requestMatchers("/api/reviews/book/**").permitAll()
                        .requestMatchers("/", "/book/**", "/info/**", "/cart", "/checkout", "/orders", "/login", "/register", "/error").permitAll() // Public views
                        .requestMatchers("/css/**", "/js/**", "/images/**", "/favicon.ico").permitAll() // Static resources
                        .requestMatchers("/admin").hasRole("ADMIN") // Protect admin view
                        .requestMatchers("/api/admin/**").hasRole("ADMIN") // Protect admin API
